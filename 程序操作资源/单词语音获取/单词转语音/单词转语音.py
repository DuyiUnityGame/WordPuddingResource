...
def text_to_speech(word, example_sentence, output_folder, lang='en'):
    ...
    try:
        # 创建 gTTS 对象
        tts = gTTS(text=f"{word}", lang=lang)
...
# 示例调用
json_file = '/Users/duyi/UnityProject/WordPuddingResource/程序操作资源/单词json/单词json2/kaoyan.json'  # 请将此路径替换为你的JSON文件路径
output_folder = '/Users/duyi/UnityProject/WordPuddingResource/程序操作资源/单词语音获取/单词转语音/kaoyan'  # 保存MP3文件的文件夹
